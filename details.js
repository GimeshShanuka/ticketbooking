...
function submitForm() {
  ...
  document.getElementById("summary-date").innerHTML = sessionStorage.getItem("local-date");
  document.getElementById("summary-time").innerHTML = sessionStorage.getItem("local-time");
  document.getElementById("summary-duration").innerHTML = sessionStorage.getItem("local-duration");
  document.getElementById("summary-tickets").innerHTML = sessionStorage.getItem("local-tickets");
  document.getElementById("summary-total").innerHTML = sessionStorage.getItem("local-total");
